...
L['ExG Guid EG'] = function(ep, gp) local e; if (ep or 0) ~= 0 then e = (ep < 0 and ' ' or ' +') .. (ep or 0) .. ' EP'; end local g; if (gp or 0) ~= 0 then g = (gp < 0 and ' -' or ' +') .. (gp or 0) .. ' GP'; end return 'EPGP Гильдии' .. (e or '') .. (g or '') end;
L['Add Raid EPGP'] = 'Добавить EPGP Рейду';
L['ExG Raid EG'] = function(ep, gp) local e; if (ep or 0) ~= 0 then e = (ep < 0 and ' ' or ' +') .. (ep or 0) .. ' EP'; end local g; if (gp or 0) ~= 0 then g = (gp < 0 and ' -' or ' +') .. (gp or 0) .. ' GP'; end return 'EPGP Рейда' .. (e or '') .. (g or '') end;
