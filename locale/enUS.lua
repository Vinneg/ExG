...
L['ExG Tooltip GP value'] = function(gp) return 'GP value: ' .. (gp or 0) end;
L['Mass Operations'] = true;
L['Add Guild EPGP'] = true;
L['ExG Guid EG'] = function(ep, gp) local e; if (ep or 0) ~= 0 then e = (ep < 0 and ' ' or ' +') .. (ep or 0) .. ' EP'; end local g; if (gp or 0) ~= 0 then g = (gp < 0 and ' -' or ' +') .. (gp or 0) .. ' GP'; end return 'Guild EPGP' .. (e or '') .. (g or '') end;
L['Add Raid EPGP'] = true;
L['ExG Raid EG'] = function(ep, gp) local e; if (ep or 0) ~= 0 then e = (ep < 0 and ' ' or ' +') .. (ep or 0) .. ' EP'; end local g; if (gp or 0) ~= 0 then g = (gp < 0 and ' -' or ' +') .. (gp or 0) .. ' GP'; end return 'Raid EPGP' .. (e or '') .. (g or '') end;
L['Guild Decay'] = true;
L['ExG Items'] = 'Items';
...
L['Disenchant'] = true;
L['ExG History Item'] = function(gp, option) return 'Add ' .. (gp or 0) .. ' GP (' .. (option or '') .. ')'; end;
