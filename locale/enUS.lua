...
L['Items Frame'] = function(page, total) return 'Items Settings. Page ' .. (page or 0) .. ' of ' .. (total or 0) .. '.' end;
L['Usage:'] = true;
...
L['ExG History Boss End Personal'] = function(boss, ep) return 'Raid EP ' .. (ep < 0 and '-' or '+') .. (ep or 0) .. ' for ' .. (boss or 'Unknown'); end;
L['ExG SetEG'] = function(name, info, ep, gp) return 'For palyer ' .. (name or 'Unknown') .. ' with idx ' .. (info.index or 0) .. ' new values EP ' .. (ep or 0) .. ' and GP ' .. (gp or 0) .. ' is set'; end;
